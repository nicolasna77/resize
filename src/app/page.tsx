...
import { ArrowRight, FileText, ImageIcon, Zap, Loader2 } from "lucide-react";
import {
  Card,
  CardDescription,
  CardHeader,
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <Card className="border-none shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl hover:-translate-y-1">
                  <CardHeader>
